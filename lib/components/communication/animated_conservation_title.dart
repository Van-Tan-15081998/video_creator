...
class AnimatedConservationTitle extends StatefulWidget {
  const AnimatedConservationTitle({super.key, required this.sizeDx, required this.sizeDy});

  final double sizeDx;
  final double sizeDy;

  @override
  State<AnimatedConservationTitle> createState() => _AnimatedConservationTitleState();
}

class _AnimatedConservationTitleState extends State<AnimatedConservationTitle> with TickerProviderStateMixin {
