...
class VocabularyDefinitionFeature with ExecutionCore, WindowFeature {
  VocabularyDefinitionFeature({required SystemStateManagement? systemStateManagement, required double? sizeDx, required double? sizeDy}) {
          ...
          builder: (context, constraints) {
            return Stack(
              ...
              children: [
                ...
                VocabularyDefinitionWidget(vocabularyDefinitionFeature: this),
              ],
            );
          },
        ),
