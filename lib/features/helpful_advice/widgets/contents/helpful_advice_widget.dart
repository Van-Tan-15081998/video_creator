...
class HelpfulAdviceWidget extends StatefulWidget {
  const HelpfulAdviceWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
...
class _HelpfulAdviceWidgetState extends State<HelpfulAdviceWidget> with SingleTickerProviderStateMixin {
  Timer? _timer;
