...
class HelpfulStudyAdviceWidget extends StatefulWidget {
  const HelpfulStudyAdviceWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
...
class _HelpfulStudyAdviceWidgetState extends State<HelpfulStudyAdviceWidget> with SingleTickerProviderStateMixin {
  Timer? _timer;
  ...
  final int totalSecondsConst = 90;
