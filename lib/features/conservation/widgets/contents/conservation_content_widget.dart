...
import 'package:frame_creator_v2/features/conservation/widgets/contents/conservation_character_widget.dart';
import 'package:frame_creator_v2/state_managements/system_state_management.dart';
import 'package:google_fonts/google_fonts.dart';

class ConservationContentWidget extends StatefulWidget {
  const ConservationContentWidget({super.key, required this.systemStateManagement, required this.sizeDx, required this.sizeDy});
  ...
  @override
  State<ConservationContentWidget> createState() => _ConservationContentWidgetState();
}

class _ConservationContentWidgetState extends State<ConservationContentWidget> {
  Timer? _timer;
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            ...
            width: widget.sizeDx,
            height: widget.sizeDy,
            child: ConservationCharacterWidget(sizeDx: widget.sizeDx, sizeDy: widget.sizeDy),
          ),
